...
their job across two times within 6 months with the same sample.
...
which is only measured once since beliefs rarely vary on a relatively short time
span.
...
In analyzing Table 1, we can recognize that the slight increase in job
satisfaction still within the standard deviation. 
